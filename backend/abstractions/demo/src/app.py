...
def get_task(task_id):
    ...
    """
    task = Task.query.filter_by(id=task_id).first() # query enables writing queries on tables
    if task is None:
...
def update_task(task_id):
    ...
    body = json.loads(request.data)
    task.description = body.get("description", task.description) # absent fields in body will not change database
